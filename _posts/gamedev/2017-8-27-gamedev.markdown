---
layout: post
title:  "Kenney Game Jam"
date:   2017-8-27 16:58:38 -0500
categories: gamedev
excerpt: Game Jam using only assets from the Kenney Site  
---
...
![correction]({{site.url}}/assets/gamedev/correction.gif){: .center-image .width-fifty}
